...
class Home extends Component{
    render(){
        return(
            ...
            <h2 className="long animated fadeInLeft">I'm a Frontend Developer, i also write </h2>
            <h2 className="long animated fadeInLeft">a little bit of <span className="purple"> Meteor.js </span> as well as <span className="purple"> React </span> </h2>
            <hr className="horizontal animated fadeIn"/>
            <p className="stay animated fadeIn">I currently work at Tradedepot Inc., I'm a passionate and driven individual who loves 
